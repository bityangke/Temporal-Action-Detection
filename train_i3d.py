...
def main(args):
    ...
    ds = build_video_dataset("ucf", train=True)['dataset']
    eval_ds = build_video_dataset("ucf", train=False)['dataset']
    ...
    eval_loader = torch.utils.data.DataLoader(
        eval_ds, batch_size=32, shuffle=True,
        num_workers=32, pin_memory=True)
...
if __name__ == '__main__':
    ...
    if args.exp_name == None:
        args.exp_name = "{}_{}".format(now, "e2e_ucf")
